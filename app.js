...
// Exposer les variables partagées sur window pour les scripts inline
// (app.js est type="module" donc ces vars ne sont pas globales automatiquement)
Object.defineProperties(window, {
  currentService:    { get:()=>currentService,    set:v=>{currentService=v;},    configurable:true },
  currentRestaurant: { get:()=>currentRestaurant, set:v=>{currentRestaurant=v;}, configurable:true },
  currentKit:        { get:()=>currentKit,        set:v=>{currentKit=v;},        configurable:true },
  cart:              { get:()=>cart,              set:v=>{cart=v;},              configurable:true },
  gpsCoords:         { get:()=>gpsCoords,         set:v=>{gpsCoords=v;},         configurable:true },
  selectedPayment:   { get:()=>selectedPayment,   set:v=>{selectedPayment=v;},   configurable:true },
  locMode:           { get:()=>locMode,           set:v=>{locMode=v;},           configurable:true },
});
...
window._openRstLocFromCurrentRestaurant = _openRstLocFromCurrentRestaurant;
